...
export { CellBase, CellChange, CellComponent, CellComponentProps, CellDescriptor, DataEditor, DataEditorComponent, DataEditorProps, DataViewer, DataViewerComponent, DataViewerProps, Dimensions, GetBindingsForCell, Matrix, Mode, Point, Props, Spreadsheet, createEmpty as createEmptyMatrix, Spreadsheet as default, getComputedValue };
